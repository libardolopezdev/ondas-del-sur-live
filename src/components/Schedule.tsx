              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0">
                    <h3 className="text-lg lg:text-xl font-bold truncate">{s.title}</h3>
                  ...
                  <div className="flex items-center gap-2">
                    {live ? (
                      ...
                      <span className="text-[10px] text-muted-foreground font-bold uppercase tracking-widest px-2 py-1 bg-slate-800/50 rounded">
                        {s.days}
                      </span>
                    )}
                  </div>
